...
-- Custom Terminal Toggle: Splits at the bottom instead of floating
...
-- Map both Ctrl+/ and Ctrl+_ (compatibility)
...
local   keymaps = {
    ...
    { "<leader>gg", function() Snacks.terminal({ "gitui" }, { cwd = vim.fn.getcwd() }) end, desc = "Lazygit" },
